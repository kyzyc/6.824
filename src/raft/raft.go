...
type Raft struct {
	...
	commitIndex int
	lastApplied int
	// only leader need below states
	// WARN: need reinitialized after election
	nextIndex  []int
	matchIndex []int
}
...
func Make(peers []*labrpc.ClientEnd, me int,
	...
	// initialize states related to logs
	rf.commitIndex = 0
	rf.lastApplied = 0
